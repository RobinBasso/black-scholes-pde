...
\includegraphics[width=0.8\textwidth]{Figures/comparison_explicit_CN_analytical.png}

\subsection{Spatial Convergence}

\includegraphics[width=0.8\textwidth]{Figures/spatial_convergence_explicit_CN.png}

\subsection{Time Convergence (Rannacher)}

\includegraphics[width=0.8\textwidth]{Figures/time_convergence_rannacher.png}
